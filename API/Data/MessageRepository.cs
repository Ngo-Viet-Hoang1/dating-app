...
namespace API.Data
{
    public class MessageRepository : IMessageRepository
    {
        ...
        public void AddMessage(Message message)
        {
            ...
            //this code to fix insert null into that field, dont know why
        ...
        public Task<PagedList<MessageDto>> GetMessagesForUser(MessageParams messageParams)
        {
            ...
            return PagedList<MessageDto>.CreateAsync(message, messageParams.PageNumber, messageParams.PageSize);
        }
